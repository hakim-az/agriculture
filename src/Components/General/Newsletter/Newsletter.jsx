...
const Newsletter = () => {
  return (
    <div className='box-container flex items-center justify-between flex-wrap p-14 gap-y-10 max-[768px]:px-5 bg-center bg-cover bg-no-repeat rounded-3xl max-[768px]:flex-col' style={{backgroundImage : `url(${NewsBg})`}}>
